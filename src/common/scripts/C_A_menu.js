...
export class Menu {
    ...
    render() {
        ...
        this.itemLogIn = new Item (
            ...
            'menu__item',
            'menu__login',
            `<a class='login-link'><div class="menu__login_svg"><svg preserveAspectRatio="xMidYMid meet" data-bbox="0 0 50 50" data-type="shape" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 50 50" role="img">
